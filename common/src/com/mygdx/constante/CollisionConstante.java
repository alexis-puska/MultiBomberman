...
public class CollisionConstante {
	 ...
	 */
	public static final short GROUP_PLAYER_MOVE = CATEGORY_WALL | CATEGORY_BRICKS | CATEGORY_BOMBE
			| CATEGORY_HOLE_BLOCK;
	public static final short GROUP_PLAYER_MOVE_PASS_WALL = CATEGORY_WALL | CATEGORY_BOMBE | CATEGORY_HOLE_BLOCK;
	...
	public static final short GROUP_BOMBE_HITBOX = CATEGORY_WALL | CATEGORY_BRICKS | CATEGORY_BOMBE
			| CATEGORY_HOLE_BLOCK | CATEGORY_FIRE | CATEGORY_PLAYER | CATEGORY_PLAYER_HITBOX;
	public static final short GROUP_TROLLEY = CATEGORY_TROLLEY | CATEGORY_PLAYER_HITBOX | CATEGORY_WALL
			| CATEGORY_BRICKS;
