...
public class CollisionConstante {
	 ...
	 */
	public static final short GROUP_PLAYER_BODY = CATEGORY_WALL | CATEGORY_BRICKS | CATEGORY_BOMBE | CATEGORY_HOLE_BLOCK;
	public static final short GROUP_PLAYER_BODY_PASS_WALL = CATEGORY_WALL | CATEGORY_BOMBE | CATEGORY_HOLE_BLOCK;
	public static final short GROUP_PLAYER_HITBOX = CATEGORY_BOMBE | CATEGORY_BONUS | CATEGORY_FIRE | CATEGORY_HOLE | CATEGORY_BUTTONS | CATEGORY_MINE | CATEGORY_TROLLEY | CATEGORY_TELEPORTER;
	public static final short GROUP_BOMBE = CATEGORY_WALL | CATEGORY_BRICKS | CATEGORY_BOMBE | CATEGORY_HOLE_BLOCK | CATEGORY_FIRE | CATEGORY_PLAYER | CATEGORY_PLAYER_HITBOX | CATEGORY_TROLLEY;
